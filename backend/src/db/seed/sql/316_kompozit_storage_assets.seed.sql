...
-- Temiz katalog / product-shot lunapark renkli urun gorselleri (ek parti)
INSERT INTO `storage_assets` (`id`, `user_id`, `name`, `bucket`, `path`, `folder`, `mime`, `size`, `width`, `height`, `url`, `provider`, `created_at`, `updated_at`) VALUES ('c3000043-0043-4043-8043-000000000043', NULL, 'lunapark-12-renkli.jpg', 'kompozit', 'uploads/kompozit/lunapark-12-renkli.jpg', 'uploads/kompozit', 'image/jpeg', 272309, 1448, 1086, '/uploads/kompozit/lunapark-12-renkli.jpg', 'local', NOW(3), NOW(3)) ON DUPLICATE KEY UPDATE `name` = VALUES(`name`), `size` = VALUES(`size`), `width` = VALUES(`width`), `height` = VALUES(`height`), `url` = VALUES(`url`), `updated_at` = VALUES(`updated_at`);
INSERT INTO `storage_assets` (`id`, `user_id`, `name`, `bucket`, `path`, `folder`, `mime`, `size`, `width`, `height`, `url`, `provider`, `created_at`, `updated_at`) VALUES ('c3000044-0044-4044-8044-000000000044', NULL, 'lunapark-13-renkli.jpg', 'kompozit', 'uploads/kompozit/lunapark-13-renkli.jpg', 'uploads/kompozit', 'image/jpeg', 288010, 1086, 1448, '/uploads/kompozit/lunapark-13-renkli.jpg', 'local', NOW(3), NOW(3)) ON DUPLICATE KEY UPDATE `name` = VALUES(`name`), `size` = VALUES(`size`), `width` = VALUES(`width`), `height` = VALUES(`height`), `url` = VALUES(`url`), `updated_at` = VALUES(`updated_at`);
INSERT INTO `storage_assets` (`id`, `user_id`, `name`, `bucket`, `path`, `folder`, `mime`, `size`, `width`, `height`, `url`, `provider`, `created_at`, `updated_at`) VALUES ('c3000045-0045-4045-8045-000000000045', NULL, 'lunapark-14-renkli.jpg', 'kompozit', 'uploads/kompozit/lunapark-14-renkli.jpg', 'uploads/kompozit', 'image/jpeg', 295441, 1086, 1448, '/uploads/kompozit/lunapark-14-renkli.jpg', 'local', NOW(3), NOW(3)) ON DUPLICATE KEY UPDATE `name` = VALUES(`name`), `size` = VALUES(`size`), `width` = VALUES(`width`), `height` = VALUES(`height`), `url` = VALUES(`url`), `updated_at` = VALUES(`updated_at`);
INSERT INTO `storage_assets` (`id`, `user_id`, `name`, `bucket`, `path`, `folder`, `mime`, `size`, `width`, `height`, `url`, `provider`, `created_at`, `updated_at`) VALUES ('c3000046-0046-4046-8046-000000000046', NULL, 'lunapark-15-renkli.jpg', 'kompozit', 'uploads/kompozit/lunapark-15-renkli.jpg', 'uploads/kompozit', 'image/jpeg', 277972, 1448, 1086, '/uploads/kompozit/lunapark-15-renkli.jpg', 'local', NOW(3), NOW(3)) ON DUPLICATE KEY UPDATE `name` = VALUES(`name`), `size` = VALUES(`size`), `width` = VALUES(`width`), `height` = VALUES(`height`), `url` = VALUES(`url`), `updated_at` = VALUES(`updated_at`);
INSERT INTO `storage_assets` (`id`, `user_id`, `name`, `bucket`, `path`, `folder`, `mime`, `size`, `width`, `height`, `url`, `provider`, `created_at`, `updated_at`) VALUES ('c3000047-0047-4047-8047-000000000047', NULL, 'lunapark-16-renkli.jpg', 'kompozit', 'uploads/kompozit/lunapark-16-renkli.jpg', 'uploads/kompozit', 'image/jpeg', 276003, 1448, 1086, '/uploads/kompozit/lunapark-16-renkli.jpg', 'local', NOW(3), NOW(3)) ON DUPLICATE KEY UPDATE `name` = VALUES(`name`), `size` = VALUES(`size`), `width` = VALUES(`width`), `height` = VALUES(`height`), `url` = VALUES(`url`), `updated_at` = VALUES(`updated_at`);
INSERT INTO `storage_assets` (`id`, `user_id`, `name`, `bucket`, `path`, `folder`, `mime`, `size`, `width`, `height`, `url`, `provider`, `created_at`, `updated_at`) VALUES ('c3000048-0048-4048-8048-000000000048', NULL, 'lunapark-17-renkli.jpg', 'kompozit', 'uploads/kompozit/lunapark-17-renkli.jpg', 'uploads/kompozit', 'image/jpeg', 395519, 1448, 1086, '/uploads/kompozit/lunapark-17-renkli.jpg', 'local', NOW(3), NOW(3)) ON DUPLICATE KEY UPDATE `name` = VALUES(`name`), `size` = VALUES(`size`), `width` = VALUES(`width`), `height` = VALUES(`height`), `url` = VALUES(`url`), `updated_at` = VALUES(`updated_at`);
INSERT INTO `storage_assets` (`id`, `user_id`, `name`, `bucket`, `path`, `folder`, `mime`, `size`, `width`, `height`, `url`, `provider`, `created_at`, `updated_at`) VALUES ('c3000049-0049-4049-8049-000000000049', NULL, 'lunapark-18-renkli.jpg', 'kompozit', 'uploads/kompozit/lunapark-18-renkli.jpg', 'uploads/kompozit', 'image/jpeg', 368023, 1448, 1086, '/uploads/kompozit/lunapark-18-renkli.jpg', 'local', NOW(3), NOW(3)) ON DUPLICATE KEY UPDATE `name` = VALUES(`name`), `size` = VALUES(`size`), `width` = VALUES(`width`), `height` = VALUES(`height`), `url` = VALUES(`url`), `updated_at` = VALUES(`updated_at`);
