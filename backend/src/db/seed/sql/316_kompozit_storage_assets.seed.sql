...
VALUES
  ('kd030001-9001-4001-9001-ffffffff0001', 'tr', 'Eskitme Bronz Kompozit Amfora', 'eskitme-bronz-kompozit-amfora', 'Bronz efektli yatay amfora formunda dekoratif kompozit obje.', 'Eskitme bronz yatay kompozit amfora', JSON_ARRAY('kompozit', 'amfora', 'dekoratif obje', 'bronz efekt'), JSON_OBJECT('kaynak', 'urunler-1.jpeg', 'form', 'Yatay amfora'), 'Eskitme Bronz Kompozit Amfora | MOE Kompozit', 'Bronz efektli yatay kompozit amfora katalog kaydi.'),
  ('kd030002-9002-4002-9002-ffffffff0002', 'tr', 'Eskitme Dokulu Kompozit Küp', 'eskitme-dokulu-kompozit-kup', 'Dik formda, eskitme yüzey dokusuna sahip dekoratif kompozit küp.', 'Eskitme dokulu dik kompozit küp', JSON_ARRAY('kompozit', 'kup', 'dekoratif obje', 'eskitme yuzey'), JSON_OBJECT('kaynak', 'urunler-2.jpeg', 'form', 'Dik kup'), 'Eskitme Dokulu Kompozit Küp | MOE Kompozit', 'Eskitme yüzeyli dik kompozit küp katalog kaydi.'),
  ('kd030003-9003-4003-9003-ffffffff0003', 'tr', 'Terracotta Kompozit Bahçe Vazosu', 'terracotta-kompozit-bahce-vazosu', 'Terracotta tonunda, dış mekan kullanımı için dekoratif kompozit bahçe vazosu.', 'Terracotta kompozit bahçe vazosu', JSON_ARRAY('kompozit', 'terracotta', 'bahce vazosu', 'dis mekan'), JSON_OBJECT('kaynak', 'urunler-3.jpeg', 'form', 'Dik vazo'), 'Terracotta Kompozit Bahçe Vazosu | MOE Kompozit', 'Terracotta renkli kompozit bahçe vazosu katalog kaydi.'),
  ('kd030004-9004-4004-9004-ffffffff0004', 'tr', 'Bronz Efektli Yatay Kompozit Küp', 'bronz-efektli-yatay-kompozit-kup', 'Bronz yüzey efektli, yatay sergilenen dekoratif kompozit küp formu.', 'Bronz efektli yatay kompozit küp', JSON_ARRAY('kompozit', 'kup', 'bronz efekt', 'dekoratif'), JSON_OBJECT('kaynak', 'urunler-4.jpeg', 'form', 'Yatay kup'), 'Bronz Efektli Yatay Kompozit Küp | MOE Kompozit', 'Bronz efektli yatay kompozit küp katalog kaydi.'),
  ('kd030005-9005-4005-9005-ffffffff0005', 'tr', 'Krem Renkli Kompozit Amfora', 'krem-renkli-kompozit-amfora', 'Krem tonlu yüzeyi ve yatay amfora formu ile dekoratif kompozit parça.', 'Krem renkli yatay kompozit amfora', JSON_ARRAY('kompozit', 'amfora', 'krem renk', 'dekoratif obje'), JSON_OBJECT('kaynak', 'urunler-5.jpeg', 'form', 'Yatay amfora'), 'Krem Renkli Kompozit Amfora | MOE Kompozit', 'Krem renkli yatay kompozit amfora katalog kaydi.'),
  ('kd030006-9006-4006-9006-ffffffff0006', 'tr', 'Kiremit Tonlu Kompozit Amfora', 'kiremit-tonlu-kompozit-amfora', 'Kiremit renginde, geniş ağızlı yatay kompozit amfora objesi.', 'Kiremit tonlu yatay kompozit amfora', JSON_ARRAY('kompozit', 'amfora', 'kiremit renk', 'dekoratif'), JSON_OBJECT('kaynak', 'urunler-6.jpeg', 'form', 'Yatay amfora'), 'Kiremit Tonlu Kompozit Amfora | MOE Kompozit', 'Kiremit tonlu yatay kompozit amfora katalog kaydi.'),
  ('kd030007-9007-4007-9007-ffffffff0007', 'tr', 'Figür Kabartmalı Kompozit Vazo', 'figur-kabartmali-kompozit-vazo', 'Yüz figürü ve kabartmalı desen detayları bulunan dekoratif kompozit vazo.', 'Figür kabartmalı kompozit vazo', JSON_ARRAY('kompozit', 'kabartma', 'figur', 'dekoratif vazo'), JSON_OBJECT('kaynak', 'urunler-7.jpeg', 'form', 'Kabartmali vazo'), 'Figür Kabartmalı Kompozit Vazo | MOE Kompozit', 'Figür kabartmalı kompozit vazo katalog kaydi.'),
  ('kd030008-9008-4008-9008-ffffffff0008', 'tr', 'Altın Tonlu Kompozit Vazo', 'altin-tonlu-kompozit-vazo', 'Parlak altın tonunda, dik formda dekoratif kompozit vazo.', 'Altın tonlu kompozit vazo', JSON_ARRAY('kompozit', 'altin ton', 'vazo', 'dekoratif'), JSON_OBJECT('kaynak', 'urunler-8.jpeg', 'form', 'Dik vazo'), 'Altın Tonlu Kompozit Vazo | MOE Kompozit', 'Altın tonlu kompozit vazo katalog kaydi.'),
  ('kd030009-9009-4009-9009-ffffffff0009', 'tr', 'Üçlü Kompozit Amfora Seti', 'uclu-kompozit-amfora-seti', 'Farklı yüzey tonlarına sahip üç parçalı dekoratif kompozit amfora seti.', 'Üçlü kompozit amfora seti', JSON_ARRAY('kompozit', 'amfora seti', 'uclu set', 'dekoratif'), JSON_OBJECT('kaynak', 'urunler-9.jpeg', 'form', 'Uclu set'), 'Üçlü Kompozit Amfora Seti | MOE Kompozit', 'Üç parçalı kompozit amfora seti katalog kaydi.'),
  ('kd030010-9010-4010-9010-ffffffff0010', 'tr', 'Hardal Tonlu Yatay Kompozit Amfora', 'hardal-tonlu-yatay-kompozit-amfora', 'Hardal sarısı yüzey tonuyla yatay amfora formunda dekoratif kompozit obje.', 'Hardal tonlu yatay kompozit amfora', JSON_ARRAY('kompozit', 'amfora', 'hardal renk', 'dekoratif'), JSON_OBJECT('kaynak', 'urunler-10.jpeg', 'form', 'Yatay amfora'), 'Hardal Tonlu Yatay Kompozit Amfora | MOE Kompozit', 'Hardal tonlu yatay kompozit amfora katalog kaydi.'),
  ('kd030011-9011-4011-9011-ffffffff0011', 'tr', 'Bahçe Tipi Kompozit Amfora Seti', 'bahce-tipi-kompozit-amfora-seti', 'Çim alan üzerinde sergilenen, farklı boy ve renkte dekoratif kompozit amfora seti.', 'Bahçe tipi kompozit amfora seti', JSON_ARRAY('kompozit', 'amfora seti', 'bahce objesi', 'dis mekan'), JSON_OBJECT('kaynak', 'urunler-11.jpeg', 'form', 'Bahce seti'), 'Bahçe Tipi Kompozit Amfora Seti | MOE Kompozit', 'Bahçe tipi kompozit amfora seti katalog kaydi.'),
  ('kd030012-9012-4012-9012-ffffffff0012', 'tr', 'Karışık Renk Kompozit Küp Seti', 'karisik-renk-kompozit-kup-seti', 'Kiremit ve bronz tonlarını bir araya getiren karışık kompozit küp seti.', 'Karışık renk kompozit küp seti', JSON_ARRAY('kompozit', 'kup seti', 'karisik renk', 'dekoratif'), JSON_OBJECT('kaynak', 'urunler-12.jpeg', 'form', 'Karisik set'), 'Karışık Renk Kompozit Küp Seti | MOE Kompozit', 'Karışık renk kompozit küp seti katalog kaydi.'),
  ('kd030013-9013-4013-9013-ffffffff0013', 'tr', 'Ayaklı Eskitme Kompozit Küp', 'ayakli-eskitme-kompozit-kup', 'Ayaklı taban detayı ve eskitme yüzeyiyle dik kompozit küp objesi.', 'Ayaklı eskitme kompozit küp', JSON_ARRAY('kompozit', 'ayakli kup', 'eskitme yuzey', 'dekoratif'), JSON_OBJECT('kaynak', 'urunler-13.jpeg', 'form', 'Ayakli kup'), 'Ayaklı Eskitme Kompozit Küp | MOE Kompozit', 'Ayaklı eskitme kompozit küp katalog kaydi.'),
  ('kd030014-9014-4014-9014-ffffffff0014', 'tr', 'Bronz Patinalı Kompozit Amfora', 'bronz-patinali-kompozit-amfora', 'Bronz patina yüzeyi belirgin, yatay formda dekoratif kompozit amfora.', 'Bronz patinalı kompozit amfora', JSON_ARRAY('kompozit', 'amfora', 'bronz patina', 'dekoratif obje'), JSON_OBJECT('kaynak', 'urunler-14.jpeg', 'form', 'Yatay amfora'), 'Bronz Patinalı Kompozit Amfora | MOE Kompozit', 'Bronz patinalı kompozit amfora katalog kaydi.'),
