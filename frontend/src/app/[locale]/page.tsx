...
export default async function HomePage({
  ...
  // Default order if API fails
  const defaultSections = [
    { id: 'hero', isActive: true },
    { id: 'stats_bar', isActive: true },
    { id: 'about', isActive: true },
    { id: 'material_cards', isActive: true },
    { id: 'industry_strip', isActive: true },
    { id: 'products', isActive: true },
    { id: 'process', isActive: true },
    { id: 'advantages', isActive: true },
    { id: 'gallery', isActive: true },
    { id: 'cta', isActive: true },
    { id: 'contact', isActive: true },
  ];

  const sectionsToRender = (sectionsApi ?? defaultSections).filter((s) => s.isActive);
  ...
  const renderSection = (id: string) => {
    switch (id) {
            ...
            <div className="container relative z-10 mx-auto px-8 text-center">
              ...
              <Reveal delay={600}>
                <div className="mt-12 flex flex-col items-center justify-center gap-6 sm:flex-row sm:gap-8">
                  ...
                  <Link
                    href={
                      heroApi?.secondaryCtaHref
                        ? homeHref(locale, heroApi.secondaryCtaHref)
                        : localizedPath(locale, '/offer')
                    }
      ...
      case 'stats_bar':
        return <StatsBar key="stats_bar" locale={locale} fromApi={statsBarApi} />;
      case 'about':
        return (
          <section key="about" id="about" className="section-py relative overflow-hidden bg-[var(--carbon)]">
              ...
              <div className="grid items-center gap-16 lg:grid-cols-2 lg:gap-24">
                <div className="order-2 lg:order-1">
                  <Reveal>
                    ...
                    <h2
                      className="section-title-cc"
                      dangerouslySetInnerHTML={{ __html: aboutApi?.title || t('home.whyUs.title') }}
                    />
      ...
      case 'material_cards':
        return <MaterialCards key="material_cards" locale={locale} fromApi={materialsApi} />;
      case 'industry_strip':
        return <IndustryStrip key="industry_strip" locale={locale} fromApi={industriesApi} />;
      case 'products':
        return (
          <section key="products" className="section-py bg-[var(--carbon)]">
            <div className="mx-auto max-w-[1300px] px-6 lg:px-12">
              <Reveal>
                ...
                {visibleProducts.map((p: any, index: number) => (
                  <Reveal key={p.id ?? p.title} delay={(index % 3) * 100} className="grid-item-cc">
                    <ListingCard
                      ...
                      imageSrc={resolvePublicAssetUrl(p.image_url) ?? p.image_url ?? PRODUCT_PLACEHOLDER_SRC}
                      imageAlt={p.title}
      ...
      case 'process':
        return <ProcessTimeline key="process" locale={locale} />;
      case 'advantages':
        return <AdvantagesGrid key="advantages" locale={locale} />;
      case 'gallery':
        return <GalleryShowcase key="gallery" locale={locale} items={visibleGalleries} />;
      case 'cta':
        return (
          <section key="cta" className="section-py relative overflow-hidden bg-(--graphite)">
              ...
              <Reveal>
                <div className="mx-auto max-w-3xl">
                  ...
                  <div className="flex flex-col items-center justify-center gap-6 sm:flex-row">
                    <Link href={localizedPath(locale, '/contact')} className="hero-btn-primary shimmer-btn">
